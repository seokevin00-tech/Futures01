...
TEMPLATES: Tuple[StrategyTemplate, ...] = (
    StrategyTemplate(
        ...
        optional_groups=("momentum", "orderflow", "volume", "multitimeframe", "vwap",
                         "profile", "imbalance", "regime", "candlestick"),
        max_optional=3,
    ...
    StrategyTemplate(
        ...
        optional_groups=("momentum", "liquidity", "structure", "vwap",
                         "supplydemand", "profile", "fibonacci", "candlestick"),
        max_optional=3,
    ...
    StrategyTemplate(
        ...
        optional_groups=("orderflow", "structure", "vwap", "momentum", "volume",
                         "supplydemand", "imbalance", "candlestick"),
        max_optional=3,
    ...
    StrategyTemplate(
        ...
        optional_filters=("outside_news_blackout", "no_imminent_release",
                          "no_recent_imbalance", "inside_bar_compression"),
